...
import 'package:getx_todo_app/constants/themes.dart';
import 'package:getx_todo_app/controllers/home_page_controller.dart';
import 'package:getx_todo_app/model/todo_model.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () async {
              await controller.box.write('darkMode', !(controller.box.read('darkMode') ?? true));
              setState(() {});
            },
            icon: Icon(
              ...
              children: [
                ...
                IconButton(
                  onPressed: () {
                    ...
                    if (task.isNotEmpty) {
                      controller.todos
                          .add(TodoModel(task, controller.todos.length, false));
                      controller.titleController.text = "";
                    }
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          backgroundColor: MyTheme.background,
          title:
              Text('Select Language'.tr, style: TextStyle(color: MyTheme.text)),
  ...
  Widget displayTodo() {
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) => (controller.tabController.index == 1 &&
                    controller.todos[index].completed) ||
                (controller.tabController.index == 2 && !controller.todos[index].completed)
            ? const SizedBox()
            : CheckboxListTile(
                ...
                secondary: IconButton(
                  onPressed: () {
                    ...
                    controller.tabController.index = controller.tabController.index;
                    setState(() {});
                  },
                  icon: Icon(
                    Icons.delete,
