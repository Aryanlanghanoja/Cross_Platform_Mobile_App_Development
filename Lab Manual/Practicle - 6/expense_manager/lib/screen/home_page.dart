    ...
    return Padding(
      ...
      child: OutlinedButton(
        ...
        child: Text(
          ...
          style: TextStyle(
            color:
                controller.selected.value != label ? Colors.grey : Colors.black,
          ),
        ),
      ),
    );
        ...
        child: charts.PieChart(
          [
            charts.Series<Expense, int>(
              ...
              data: [
                Expense(0, controller.income.value.toInt()),
                Expense(1, controller.spent.value.toInt()),
              ],
              colorFn: (datum, index) => [
                charts.ColorUtil.fromDartColor(const Color(0xFFb6d8ae)),
                charts.ColorUtil.fromDartColor(const Color(0xFFfeb9ab)),
              ][index!],
            ),
          ],
          animate: false,
