import 'package:e_book/screens/dashboard.dart';
...
class _IntroductionPageState extends State<IntroductionPage> {
  ...
  Widget build(BuildContext context) {
    List<PageViewModel> listPagesViewModel = [
      introPageModel("Welcome", "Welcome to this awesome intro screen app.",
          "assets/images/intro_1.png", const Color.fromRGBO(126, 196, 128, 1)),
      introPageModel(
          "Awesome App",
          "This is an awesome app, of intro screen design",
          "assets/images/intro_2.png",
          const Color.fromRGBO(98, 181, 243, 1)),
      introPageModel("Flutter App", "Flutter is awesome fro app development",
          "assets/images/intro_3.png", const Color.fromRGBO(123, 133, 205, 1)),
    ];
  ...
  introPageModel(
      String title, String bodyText, String imgPath, Color backColor) {
